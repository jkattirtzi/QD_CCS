...
set xrange [-0.100000 : 50.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [0.00000:50.0000] )
set ylabel "Re(ACF) " 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by 90
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by 90
set yrange [ * : * ] noreverse nowriteback  # (currently [-1.00000:1.20000] )
set y2range [ * : * ] noreverse nowriteback  # (currently [-0.860928:1.00006] )
set zlabel "" 
...
GNUTERM = "x11"
plot 'M12SymBS50.acf' u 2:3 w l lt 13 lw 3, 'M12SymBS.acf' u 2:3 w l lt 3 lw 3
#    EOF
